	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		if (args.length == 1 && sender.hasPermission("SimpleQueues.reset")) {
			...
			if (args[0].equalsIgnoreCase("-a")) {
				...
				sender.sendMessage(MessageColor.NORMAL + "All queues have been reset.");
			...
			// ./qreset <queue>
				...
				// Reset queue
				queue.reset();
				sender.sendMessage(MessageColor.NORMAL + "The queue " + MessageColor.HIGHLIGHT + queue.name + MessageColor.NORMAL + " has been reset.");
